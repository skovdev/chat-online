    ...
    return (
        ...
        <div className="login-container">
            ...
            <Form name="normal_login" className="login-form" initialValues={{remember: true}} onFinish={onFinish}>
                ...
                <Form.Item name="profilePicUrl" rules={[{ required: true, message: "Please input your profile picture URL!", }, ]} >
                    <Input size="large" placeholder="Profile picture url" />
                </Form.Item>
                <Form.Item>
                    <Button shape="round" size="large" htmlType="submit" className="login-form-button" loading={loading}>Signup</Button>
                </Form.Item>
