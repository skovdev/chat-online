...
const Chat = (props) => {
    ...
    useEffect(() => {
        ...
        findChatMessage(activeContact.id, currentUser.id)
        .then((msgs) =>
            setMessages(msgs)
        );
    ...
    const onMessageReceived = (msg) => {
        ...
        if (active.id === notification.senderId) {
            findChatMessage(notification.id).then((message) => {
                const newMessage = JSON.parse(sessionStorage.getItem("recoil-persist")).chatMessages;
    ...
    return (
        ...
        <div id="frame">
            <div id="sidepanel">
                <div id="profile">
                    <div class="wrap">
                        <img id="profile-img" src={currentUser.profilePicture} class="online" />
                ...
                <div id="contacts">
                    <ul>
                        ...
                        <li onClick={() => setActiveContact(contact)} class={ activeContact && contact.id === activeContact.id ? "contact active" : "contact"} >
                            <div class="wrap">
            ...
            <div class="content">
                        ...
                        {messages.map((msg) => (
                            <li class={msg.senderId === currentUser.id ? "sent" : "replies"}>
                                {msg.senderId !== currentUser.id && (
                                    <img src={activeContact.profilePicture} />
                                )}
                                <p>{msg.content}</p>
                            </li>
                        ))}
                ...
                <div class="message-input">
                    <div class="wrap">
                        ...
                        <Button icon={
                            <i class="fa fa-paper-plane" aria-hidden="true"></i>} onClick={() => {
                                sendMessage(text);
                                setText("");
                            }}
                        />
